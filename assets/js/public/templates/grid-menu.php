			...
			<ul class="wpmoly-grid-menu-container">
					...
					<li class="wpmoly-grid-menu-item wpmoly-grid-menu-item-search">
						<a class="grid-menu-action" data-action="opensearch" href="#" title=""><span class="wpmolicon icon-search"></span> <span class="label">Search</span></a>
						<div class="grid-menu-search-container">
							<input type="text" placeholder="Search..." />
							<a href="#" title="Launch search!" data-action="search"><span class="wpmolicon icon-arrow-right2"></span></a>
						</div>
					</li>
				</ul>
