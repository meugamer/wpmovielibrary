 ...
 */
editor.view.Movies = wpmoly.View.extend({
 ...
 * for use in the Edit Movie modal.
 *
 * @since    2.2
 */
editor.view.TwoColumn = editor.view.Movie.extend({
...
editor.view.PreviewMovie = editor.view.Movie.extend({
 ...
 */
editor.view.MovieModal = wp.media.view.MediaFrame.extend({
