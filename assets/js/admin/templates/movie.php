		...
		<div class="attachment-preview movie-preview js--select-attachment" style="<# if ( '' != data.size.height ) { #>height:{{ data.size.height }}px;<# } if ( '' != data.size.height ) { #>width:{{ data.size.width }}px<# } #>">
			<a class="movie-action center preview-movie" href="#" title="<?php _e( 'View Movie', 'wpmovielibrary' ); ?>"><span class="wpmolicon icon-movie"></span></a>
			<a class="movie-action top-right edit-movie" href="#" title="<?php _e( 'Edit Movie', 'wpmovielibrary' ); ?>"><span class="wpmolicon icon-edit"></span></a>
