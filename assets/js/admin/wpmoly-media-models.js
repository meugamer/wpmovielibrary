...
( function( $, _, Backbone, wp, wpmoly ) {
	 ...
	 * @since    2.2
	 */
	media.Model.Backdrops = media.Model.Attachments.extend( { model: media.Model.Backdrop, _type: 'backdrops' } ),
	 ...
	 * @since    2.2
	 */
	media.Model.Posters = media.Model.Attachments.extend( { model: media.Model.Poster, _type: 'posters' } );
