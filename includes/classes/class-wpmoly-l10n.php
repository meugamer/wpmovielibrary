		...
		*/
		...
		public static function localize_script() {
			...
			$lang = array(
				...
				'import_posters'		=> __( 'Import Poster', 'wpmovielibrary' ),
				'import_posters_title'	=> __( 'Select a poster for "%s"', 'wpmovielibrary' ),
				'import_posters_wait'	=> __( 'Please wait while the poster is uploaded...', 'wpmovielibrary' ),
				...
				'search_movie'		=> __( 'loading metadata...', 'wpmovielibrary' ),
