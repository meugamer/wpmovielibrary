...
class Core {
	...
	public function __construct() {
		...
		$this->status_codes = array(
			...
			1  => array(
				'code' => 'success',
				'http' => 200,
				'message' => __( 'Success.', 'wpmovielibrary' ),
			),
			2  => array(
				'code' => 'invalid_service',
				'http' => 501,
				'message' => __( 'Invalid service: this service does not exist.', 'wpmovielibrary' ),
			),
			3  => array(
				'code' => 'permission_denied',
				'http' => 401,
				'message' => __( 'Authentication failed: You do not have permissions to access the service.', 'wpmovielibrary' ),
			),
			4  => array(
				'code' => 'invalid_format',
				'http' => 405,
				'message' => __( 'Invalid format: This service doesn\'t exist in that format.', 'wpmovielibrary' ),
			),
			5  => array(
				'code' => 'invalid_parameters',
				'http' => 422,
				'message' => __( 'Invalid parameters: Your request parameters are incorrect.', 'wpmovielibrary' ),
			),
			6  => array(
				'code' => 'invalid_id',
				'http' => 404,
				'message' => __( 'Invalid id: The pre-requisite id is invalid or not found.', 'wpmovielibrary' ),
			),
			7  => array(
				'code' => 'invalid_key',
				'http' => 401,
				'message' => __( 'Invalid API key: You must be granted a valid key.', 'wpmovielibrary' ),
			),
			8  => array(
				'code' => 'duplicate_entry',
				'http' => 403,
				'message' => __( 'Duplicate entry: The data you tried to submit already exists.', 'wpmovielibrary' ),
			),
			9  => array(
				'code' => 'service_offline',
				'http' => 503,
				'message' => __( 'Service offline: This service is temporarily offline, try again later.', 'wpmovielibrary' ),
			),
			10 => array(
				'code' => 'suspended_key',
				'http' => 401,
				'message' => __( 'Suspended API key: Access to your account has been suspended, contact TMDb.', 'wpmovielibrary' ),
			),
			11 => array(
				'code' => 'internal_error',
				'http' => 500,
				'message' => __( 'Internal error: Something went wrong, contact TMDb.', 'wpmovielibrary' ),
			),
			12 => array(
				'code' => 'item_updated',
				'http' => 201,
				'message' => __( 'The item/record was updated successfully.', 'wpmovielibrary' ),
			),
			13 => array(
				'code' => 'item_deleted',
				'http' => 200,
				'message' => __( 'The item/record was deleted successfully.', 'wpmovielibrary' ),
			),
			14 => array(
				'code' => 'authentication_failed',
				'http' => 401,
				'message' => __( 'Authentication failed.', 'wpmovielibrary' ),
			),
			15 => array(
				'code' => 'failed',
				'http' => 500,
				'message' => __( 'Failed.', 'wpmovielibrary' ),
			),
			16 => array(
				'code' => 'device_denied',
				'http' => 401,
				'message' => __( 'Device denied.', 'wpmovielibrary' ),
			),
			17 => array(
				'code' => 'session_denied',
				'http' => 401,
				'message' => __( 'Session denied.', 'wpmovielibrary' ),
			),
			18 => array(
				'code' => 'validation_denied',
				'http' => 400,
				'message' => __( 'Validation failed.', 'wpmovielibrary' ),
			),
			19 => array(
				'code' => 'invalid_header',
				'http' => 406,
				'message' => __( 'Invalid accept header.', 'wpmovielibrary' ),
			),
			20 => array(
				'code' => 'invalid_date_range',
				'http' => 422,
				'message' => __( 'Invalid date range: Should be a range no longer than 14 days.', 'wpmovielibrary' ),
			),
			21 => array(
				'code' => 'not_found',
				'http' => 200,
				'message' => __( 'Entry not found: The item you are trying to edit cannot be found.', 'wpmovielibrary' ),
			),
			22 => array(
				'code' => 'invalid_page',
				'http' => 400,
				'message' => __( 'Invalid page: Pages start at 1 and max at 1000. They are expected to be an integer.', 'wpmovielibrary' ),
			),
			23 => array(
				'code' => 'invalid_date_format',
				'http' => 400,
				'message' => __( 'Invalid date: Format needs to be YYYY-MM-DD.', 'wpmovielibrary' ),
			),
			24 => array(
				'code' => 'request_timeout',
				'http' => 504,
				'message' => __( 'Your request to the backend server timed out. Try again.', 'wpmovielibrary' ),
			),
			25 => array(
				'code' => 'request_limit',
				'http' => 429,
				'message' => __( 'Your request count (#) is over the allowed limit of (40).', 'wpmovielibrary' ),
			),
			26 => array(
				'code' => 'authentication_required',
				'http' => 400,
				'message' => __( 'You must provide a username and password.', 'wpmovielibrary' ),
			),
			27 => array(
				'code' => 'append_limit',
				'http' => 400,
				'message' => __( 'Too many append to response objects: The maximum number of remote calls is 20.', 'wpmovielibrary' ),
			),
			28 => array(
				'code' => 'invalid_timezone',
				'http' => 400,
				'message' => __( 'Invalid timezone: Please consult the documentation for a valid timezone.', 'wpmovielibrary' ),
			),
			29 => array(
				'code' => 'confirm_required',
				'http' => 400,
				'message' => __( 'You must confirm this action: Please provide a confirm=true parameter.', 'wpmovielibrary' ),
			),
			30 => array(
				'code' => 'invalid_credential',
				'http' => 401,
				'message' => __( 'Invalid username and/or password: You did not provide a valid login.', 'wpmovielibrary' ),
			),
			31 => array(
				'code' => 'disabled_account',
				'http' => 401,
				'message' => __( 'Account disabled: Your account is no longer active. Contact TMDb if this is an error.', 'wpmovielibrary' ),
			),
			32 => array(
				'code' => 'unverified_email',
				'http' => 401,
				'message' => __( 'Email not verified: Your email address has not been verified.', 'wpmovielibrary' ),
			),
			33 => array(
				'code' => 'invalid_token',
				'http' => 401,
				'message' => __( 'Invalid request token: The request token is either expired or invalid.', 'wpmovielibrary' ),
			),
			34 => array(
				'code' => 'resource_not_found',
				'http' => 401,
				'message' => __( 'The resource you requested could not be found.', 'wpmovielibrary' ),
			),
		);
	}
	...
	protected function validate_query( $query, $type = 'search' ) {
		...
		} elseif ( 'tmdb' == $type && ! preg_match( '/^\d{1,6}$/', $query ) ) {
