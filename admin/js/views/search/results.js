...
Search.Result = wp.Backbone.View.extend({
...
Search.ResultsHeader = wp.Backbone.View.extend({
...
Search.ResultsMenu = wp.Backbone.View.extend({
...
Search.ResultsList = wp.Backbone.View.extend({
...
Search.Results = wp.Backbone.View.extend({
	...
	set_regions : function() {
		...
		this.header  = new wpmoly.view.Search.ResultsHeader({
			controller : this.controller,
			collection : this.controller.results,
			frame      : this,
		});
		this.content = new wpmoly.view.Search.ResultsList({
			controller : this.controller,
			collection : this.controller.results,
			frame      : this,
		});
		this.menu    = new wpmoly.view.Search.ResultsMenu({
			controller : this.controller,
			collection : this.controller.results,
			frame      : this,
		});
