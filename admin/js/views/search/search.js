...
Search.SearchForm = wp.Backbone.View.extend({
...
Search.Search = wp.Backbone.View.extend({
	...
	set_regions : function() {
		...
		this.settings = new wpmoly.view.Search.Settings({
			controller : this.controller,
			model      : this.controller.settings,
		});
		this.search   = new wpmoly.view.Search.SearchForm({
			controller : this.controller,
			model      : this.controller.search,
		});
