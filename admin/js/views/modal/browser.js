...
Modal.ImagesToolbar = wp.media.View.extend({
	...
	render : function() {
		...
		this.$el.html( this.template( { mode : this.controller.frame.content.mode() } ) );
...
Modal.ImagesSidebar = wp.media.View.extend({
...
Modal.ImagesBrowser = wp.media.View.extend({
