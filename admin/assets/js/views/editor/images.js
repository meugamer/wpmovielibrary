...
wpmoly.view.ImageList = wp.Backbone.View.extend({
...
wpmoly.view.ImageEditor = wp.Backbone.View.extend({
...
wpmoly.view.Images = wpmoly.view.Frame.extend({
...
wpmoly.view.BackdropList = wpmoly.view.ImageList.extend({
...
wpmoly.view.PosterList = wpmoly.view.ImageList.extend({
...
wpmoly.view.BackdropEditor = wpmoly.view.ImageEditor.extend({
...
wpmoly.view.PosterEditor = wpmoly.view.ImageEditor.extend({
...
wpmoly.view.Backdrops = wpmoly.view.Images.extend({
...
wpmoly.view.Posters = wpmoly.view.Images.extend({
