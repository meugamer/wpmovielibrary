						...
						'grid-preset' => array(
							...
							'choices' => array(
								'alphabetical-actors' => array(
									...
									'url'   => WPMOLY_URL . 'admin/assets/img/alphabetical-actors.png',
								),
								'unalphabetical-actors' => array(
									'label' => esc_html__( 'Unalphabetical Actors', 'wpmovielibrary' ),
									'url'   => WPMOLY_URL . 'admin/assets/img/unalphabetical-actors.png',
								),
							),
							'sanitize' => 'esc_attr',
						),
			...
			<div id="wpmoly-grid-builder-preview" class="grid-builder-preview with-tutorial">
				<div id="wpmoly-grid-builder-tutorial" class="grid-builder-tutorial" data-tutorial-grid="<?php echo esc_attr( $post->ID ); ?>">
					...
					<div class="tutorial-step step-1 clearfix">
						<img class="step-capture" src="<?php echo WPMOLY_URL . 'admin/assets/img/tutorial-grid-type.png'; ?>" alt="" />
					...
					<div class="tutorial-step step-2 clearfix">
						<img class="step-capture" src="<?php echo WPMOLY_URL . 'admin/assets/img/tutorial-grid-mode.png'; ?>" alt="" />
						<div class="step-content">
					...
					<div class="tutorial-step step-3 clearfix">
						<img class="step-capture" src="<?php echo WPMOLY_URL . 'admin/assets/img/tutorial-grid-theme.png'; ?>" alt="" />
						<div class="step-content">
					...
					<div class="tutorial-step step-4 clearfix">
						...
						<img class="step-capture" src="<?php echo WPMOLY_URL . 'admin/assets/img/tutorial-grid-settings.png'; ?>" alt="" />
					</div>
				</div>
			</div>
<?php } else { ?>
