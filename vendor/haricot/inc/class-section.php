...
class Haricot_Section {
	...
	public function is_active() {
		...
		return apply_filters( 'haricot_is_section_active', $is_active, $this );
	}
	...
	public function print_template() { ?>
		...
		<script type="text/html" id="tmpl-haricot-section-<?php echo esc_attr( $this->type ); ?>">
	...
	public function get_template() {
		haricot_get_section_template( $this->type );
	}
}
