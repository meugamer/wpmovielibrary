<?php
/**
 * Setting class for storing multiple term meta values for a single key.
 *
 * @package    Haricot
 ...
 * @access public
 */
class Haricot_Setting_Multiple extends Haricot_Setting {
	...
	public function get_value() {
		...
		return get_term_meta( $this->manager->term_id, $this->name );
	}
	...
	public function add_value( $value ) {
		...
		return add_term_meta( $this->manager->term_id, $this->name, $value, false );
	}
	...
	public function remove_value( $value ) {
		...
		return delete_term_meta( $this->manager->term_id, $this->name, $value );
	}
}
