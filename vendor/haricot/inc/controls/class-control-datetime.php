 ...
 * @access public
 */
class Haricot_Control_Datetime extends Haricot_Control {
	 ...
	 * `Haricot_Setting_Date` class will store the time as `00:00:00` if
	 * no time is provided.
	 *
	 * @since  1.0.0
	 * @access public
	...
	public function to_json() {
		...
		$this->json['month'] = array(
			...
			'label'   => esc_html__( 'Month', 'haricot' ),
			'choices' => array(
				array(
					'num'   => '',
					'label' => ''
		...
		$this->json['minute'] = array(
			...
			'label' => esc_html__( 'Minute', 'haricot' ),
			'attr'  => 'placeholder="00" size="2" maxlength="2" autocomplete="off"'
		);
		...
		$this->json['second'] = array(
			...
			'label' => esc_html__( 'Second', 'haricot' ),
			'attr'  => 'placeholder="00" size="2" maxlength="2" autocomplete="off"'
		);
	}
}
