		...
		<div class="headbox-content clearfix">
			<div class="headbox-titles">
				<div class="headbox-title">
					<div class="term-title <?php echo $headbox->get_type(); ?>-title"><a href="<?php echo get_term_link( $collection->term, 'collection' ); ?>"><?php $collection->the_name(); ?></a></div>
				</div>
				<div class="headbox-subtitle">
					<div class="term-count <?php echo $headbox->get_type(); ?>-count"><?php printf( _n( '%d Movie', '%d Movies', $collection->term->count, 'wpmovielibrary' ), $collection->term->count ); ?></div>
				</div>
			</div>
			<div class="headbox-metadata">
				<div class="headbox-description">
					<div class="term-description <?php echo $headbox->get_type(); ?>-description"><?php $collection->the_description(); ?></div>
				</div>
			</div>
		</div>
	</div>
