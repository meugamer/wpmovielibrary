<?php
/**
 * Movies Grid 'archive' mode template.
 * 
 * @since    3.0
 * 
 * @uses    $grid
...
?>
	...
	<div id="wpmoly-grid-<?php echo $grid->id; ?>" class="wpmoly grid-<?php echo $grid->id; ?> shortcode movies grid archive theme-<?php echo $grid->get_theme(); ?>" data-grid="<?php echo $grid->id; ?>">
