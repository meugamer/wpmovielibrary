...
?>
	...
	<div id="wpmoly-grid-<?php echo $grid->id; ?>" class="wpmoly shortcode actors grid theme-<?php echo $grid->get_theme(); ?> <?php echo $grid->get_columns(); ?>-columns" data-grid="<?php echo $grid->id; ?>">
