<?php
/**
 * Movies Grid 'list' mode template.
 * 
 * @since    3.0
 * 
 * @uses    $grid
...
?>
	...
	<div id="wpmoly-grid-<?php echo $grid->id; ?>" class="wpmoly grid-<?php echo $grid->id; ?> shortcode movies grid list theme-<?php echo $grid->get_theme(); ?>" data-grid="<?php echo $grid->id; ?>" data-columns="<?php echo $grid->get_list_columns(); ?>">
