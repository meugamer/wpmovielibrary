...
if ( ! $is_json ) :
?>
			<div class="grid-content-inner grid <?php echo $grid->get_columns(); ?>-columns theme-variant-1">
<?php
	if ( $items->has_items() ) :
...
?>
				<div class="node post-node movie">
					...
					<div class="node-content">
						...
						<div class="node-rating post-rating movie-rating"><?php echo get_formatted_movie_rating( $movie->get( 'rating' ), array( 'show_text' => false, 'is_link' => false ) ); ?></div>
						<div class="node-readmore"><a href="<?php echo get_the_permalink( $movie->id ); ?>">+</a></div>
					</div>
				</div>
<?php
		endwhile;
