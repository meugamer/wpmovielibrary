...
?>
	...
	<div id="wpmoly-grid-<?php echo $grid->id; ?>" class="wpmoly shortcode collections grid theme-<?php echo $grid->get_theme(); ?> <?php echo $grid->get_columns(); ?>-columns" data-grid="<?php echo $grid->id; ?>" data-columns="<?php echo $grid->get_columns(); ?>" data-rows="<?php echo $grid->get_rows(); ?>" data-column-width="<?php echo $grid->get_column_width(); ?>" data-row-height="<?php echo $grid->get_row_height(); ?>">
