...
<# 	if ( 'movie' === data.settings.get( 'type' ) ) { #>
		<div class="grid-setting-block half-col orderby-setting">
			...
			<span class="grid-setting-input">
				<input id="{{ data.grid_id }}-orderby-title" name="{{ data.grid_id }}-orderby[]" type="radio" data-setting-type="orderby" value="title" <# if ( 'title' == data.query.get( 'orderby' ) ) { #>checked="checked" <# } #>/><label for="{{ data.grid_id }}-orderby-title" class="value"><?php _e( 'Title', 'wpmovielibrary' ); ?></label>
			</span>
			<span class="grid-setting-input">
				<input id="{{ data.grid_id }}-orderby-date" name="{{ data.grid_id }}-orderby[]" type="radio" data-setting-type="orderby" value="date" <# if ( 'date' == data.query.get( 'orderby' ) ) { #>checked="checked" <# } #>/><label for="{{ data.grid_id }}-orderby-date" class="value"><?php _e( 'Date', 'wpmovielibrary' ); ?></label>
			</span>
		</div>
<# 	} #>
		...
		<div class="grid-setting-block half-col order-setting">
			...
			<span class="grid-setting-input">
				<input id="{{ data.grid_id }}-order-asc" name="{{ data.grid_id }}-order[]" type="radio" data-setting-type="order" value="asc" <# if ( 'asc' == data.query.get( 'order' ) ) { #>checked="checked" <# } #>/><label for="{{ data.grid_id }}-order-asc" class="value"><?php _e( 'Ascendingly', 'wpmovielibrary' ); ?></label>
			</span>
			<span class="grid-setting-input">
				<input id="{{ data.grid_id }}-order-desc" name="{{ data.grid_id }}-order[]" type="radio" data-setting-type="order" value="desc" <# if ( 'desc' == data.query.get( 'order' ) ) { #>checked="checked" <# } #>/><label for="{{ data.grid_id }}-order-desc" class="value"><?php _e( 'Descendingly', 'wpmovielibrary' ); ?></label>
			</span>
		</div>
<# } #>
