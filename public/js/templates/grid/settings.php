...
?>
		...
		<div class="grid-setting-block half-col orderby-setting">
			...
			<label><input type="radio" name="grid-settings[orderby][]" data-setting-type="orderby" data-setting-value="" value="" <# if ( 'post_title' == data.query.get( 'orderby' ) ) { #>checked="checked" <# } #>/><span class="value"><?php _e( 'Post Title', 'wpmovielibrary' ); ?></span></label>
			<label><input type="radio" name="grid-settings[orderby][]" data-setting-type="orderby" data-setting-value="" value="" <# if ( 'post_date' == data.query.get( 'orderby' ) ) { #>checked="checked" <# } #>/><span class="value"><?php _e( 'Post Date', 'wpmovielibrary' ); ?></span></label>
		</div>

		<div class="grid-setting-block half-col order-setting">
			<span class="grid-setting-label"><?php _e( 'Order:', 'wpmovielibrary' ); ?></span>
			<label><input type="radio" name="grid-settings[order][]" data-setting-type="order" data-setting-value="" value="" <# if ( 'ASC' == data.query.get( 'order' ) ) { #>checked="checked" <# } #>/><span class="value"><?php _e( 'Ascendingly' ); ?></span></label>
			<label><input type="radio" name="grid-settings[order][]" data-setting-type="order" data-setting-value="" value="" <# if ( 'DESC' == data.query.get( 'order' ) ) { #>checked="checked" <# } #>/><span class="value"><?php _e( 'Descendingly' ); ?></span></label>
		</div>
