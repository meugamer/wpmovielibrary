...
#>
			<div class="grid-custom-block half-col">
				...
				<span class="grid-setting-input">
					<input id="{{ data.grid_id }}-display-collections" name="{{ data.grid_id }}-display[]" type="checkbox" data-setting-type="display" value="" <# if ( _.contains( data.settings.get( 'display' ), 'collections' ) ) { #>checked="checked" <# } #>/><label for="{{ data.grid_id }}-display-collections" class="value"><?php _e( 'Collections', 'wpmovielibrary' ); ?></label>
				</span>
				<span class="grid-setting-input">
...
<#
		} else if ( _.contains( [ 'actors', 'collections', 'genres' ], data.settings.get( 'type' ) ) ) {
#>
			<div class="grid-custom-block half-col">
				<span class="grid-setting-label"><?php _e( 'Display:', 'wpmovielibrary' ); ?></span>
				<span class="grid-setting-input">
