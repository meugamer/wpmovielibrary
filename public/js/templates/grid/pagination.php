...
<# } #>
			<div class="pagination-menu"><span class="page-label"><?php _e( 'Page', 'wpmovielibrary' ); ?></span><span class="current-page"><input type="text" size="1" data-action="grid-paginate" value="{{ data.current }}" <# if ( data.preview ) { #>readonly="true" <# } #>/></span><span class="of-label"><?php _e( 'of', 'wpmovielibrary' ); ?></span><span class="total-pages">{{ data.total }}</span></div>
