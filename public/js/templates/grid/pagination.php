...
<# } #>
			<div class="pagination-menu">Page <span class="current-page"><input type="text" size="1" data-action="grid-paginate" value="{{ data.state.get( 'currentPage' ) }}" /></span> of <span class="total-pages">{{ data.state.get( 'totalPages' ) }}</span></div>
